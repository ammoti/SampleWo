...
from SamplesWo.domain.storageroom import StorageRoom
...
@mock.patch('SamplesWo.use_cases.storageroom_use_cases.StorageRoomListUseCase')
...
def test_request_object_initialisation_and_use_with_filters(mock_use_case, client):
    ...
    request_object_class = 'SamplesWo.use_cases.request_objects.StorageRoomListRequestObject'
